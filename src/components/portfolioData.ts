...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'jQuery', level: 'Expert', iconName: 'Code' }
    ]
  },
  {
    id: 'devops-tooling',
...
export const flagshipProjects: CaseStudy[] = [
  {
    ...
    highlights: [
      'Designed high-performance relational schemas using C# and SQL Server to handle multi-million rows securely',
      'Engineered clean modular JavaScript interfaces to substitute legacy heavy-data grids, saving up to 60% client memory',
      'Overlooked critical architecture upgrades across its developmental cycle, standardizing APIs and DB schemas'
    ],
    metrics: [
...
export const freelanceProjects = [
  {
    ...
    highlights: [
      'Features deep server-side rendering (SSR) for superior SEO metrics and blazing-fast performance',
      'Backed by Strapi Headless CMS giving custom non-technical personnel edit powers seamlessly',
      'MongoDB storage networks configured for unstructured logging and highly scalable article indexing'
    ],
  ...
  },
  {
    ...
    highlights: [
      'Integrates highly-complex Unity WebGL embedded environments, smoothly rendering interactive 3D instructional courses',
      'Automated custom PDF reporting generation matrices translating student actions to performance report packets',
      'An integrated generative support chat layout guiding active user exploration using secure private contexts'
    ],
    tags: ['Next.js', 'Unity WebGL', 'Node.js', 'Generative Chat']
  }
];
...
export const careerTimeline: ExperienceItem[] = [
  ...
  },
  {
    ...
    impacts: [
      'Engineered localized transactional modules satisfying tax structures in both Korea and multi-province global setups',
      'Resolved deep structural query bottlenecks, reducing batch monthly closing times on high-activity client instances by 50%',
      'Integrated automated testing frameworks enabling rapid regression feedback during rapid iterative release cycles'
    ],
