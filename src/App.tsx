...
export default function App() {
  ...
  const getSkillIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'Server': return <Server className="w-4 h-4 text-sky-400" />;
      ...
      case 'Cpu': return <Cpu className="w-4 h-4 text-amber-500" />;
      case 'Cloud': return <Cloud className="w-4 h-4 text-sky-400" />;
      case 'GitFork': return <GitFork className="w-4 h-4 text-slate-400" />;
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-slate-200/80 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-16 sm:h-20 flex items-center justify-between">
          ...
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-sky-500 to-cyan-500 p-[1.5px] shadow-sm group-hover:shadow-md transition-all duration-300">
              <div className="w-full h-full bg-white rounded-[10px] flex items-center justify-center">
                <span className="font-display font-bold text-slate-800 text-sm sm:text-base tracking-wider bg-gradient-to-r from-indigo-600 to-sky-600 bg-clip-text text-transparent">FS</span>
              </div>
            </div>
            <div>
            ...
            {['Skills', 'Case Studies', 'Interactive Maps', 'Timeline', 'Contact'].map((section, idx) => {
              ...
              return (
                <button
                  ...
                  className="hover:text-indigo-600 transition-colors duration-200 relative py-1 cursor-pointer"
                >
                  {section}
                </button>
              );
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              id="header-mailto"
              href="mailto:mehboobfazal36@gmail.com"
              className="px-4 py-2 text-xs font-semibold font-display text-slate-700 hover:text-indigo-600 border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 rounded-xl transition-all"
            >
              Get In Touch
            </a>
          </div>
          ...
          <button
            ...
            className="md:hidden p-2 text-slate-600 hover:text-indigo-600 focus:outline-none cursor-pointer"
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-b border-slate-200 bg-white/95 overflow-hidden"
            >
              <div className="px-6 py-4 flex flex-col gap-4 text-sm font-medium">
                {['Skills', 'Case Studies', 'Interactive Maps', 'Timeline', 'Contact'].map((section, idx) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => scrollToSection(targetId)}
                      className="text-left py-2 text-slate-600 hover:text-indigo-650 transition-colors"
                    >
                      {section}
                    </button>
                  );
                ...
                <div className="border-t border-slate-200 pt-4 flex gap-3">
                  <a
                    id="mobile-mailto"
                    href="mailto:mehboobfazal36@gmail.com"
                    className="flex-1 text-center py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold font-display"
                  >
                    Email Me
                  </a>
                </div>
        ...
        <section id="hero" className="relative min-h-[95vh] flex items-center pt-16 pb-16 overflow-hidden bg-gradient-to-b from-white to-slate-50/50">
          ...
          <div className="max-w-7xl mx-auto px-6 w-full z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col">
              ...
              <h1 className="font-display font-bold text-5xl sm:text-6xl md:text-7xl tracking-tight leading-none mb-3 bg-gradient-to-r from-indigo-700 via-sky-600 to-cyan-600 text-transparent bg-clip-text">
                FAZAL SHAH
              </h1>
              <p className="text-indigo-600 font-semibold tracking-wider text-xs uppercase mb-4 font-mono">
                Senior Full-Stack & AI Engineer
              </p>

              {/* Tagline */}
              <p className="text-lg sm:text-xl font-display font-medium text-slate-700 max-w-2xl mb-4 leading-relaxed">
                Building reliable cloud SaaS architectures and tailored artificial intelligence pipelines.
              </p>
              ...
              <div className="flex flex-wrap gap-4 items-center">
                <a
                  ...
                  className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-sm rounded-xl shadow-sm hover:translate-y-[-1px] transition-all duration-200 cursor-pointer"
                >
                  Contact Me
                </a>
                ...
                <a
                  ...
                  className="px-5 py-3 text-sm font-semibold text-slate-700 hover:text-indigo-600 border border-slate-200 hover:border-slate-350 bg-white hover:bg-slate-50 rounded-xl flex items-center gap-2 transition-all cursor-pointer"
                >
              ...
              <div className="w-full max-w-[420px] aspect-square rounded-2xl bg-white border border-slate-200/80 p-6 flex flex-col justify-between shadow-sm relative">
                ...
                <div className="my-6">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Helping teams replace legacy configurations with modular service designs, optimized relational databases, and clean frontend workspaces.
                  </p>
                </div>
        ...
        <section id="skills" className="py-20 bg-slate-50/50 border-t border-slate-200/80 relative">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl mb-12">
              ...
              <p className="text-xl text-slate-800 font-display font-semibold tracking-tight sm:text-3xl leading-snug">
                Deep expertise in backend databases, modern frameworks, and production-ready architectures.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-10 pb-4 border-b border-slate-200">
              <button
                ...
                className={`px-4 py-2 text-xs font-semibold font-display rounded-lg border transition-all cursor-pointer ${
                  activeCategory === 'all' 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {skillCategories
                ...
                .map((cat) => (
                  <div
                    key={cat.id}
                    className="p-6 bg-white border border-slate-200 rounded-2xl flex flex-col justify-between hover:border-slate-350 hover:shadow-xs transition-all duration-200"
                  >
                    <div>
                    ...
                    <div className="space-y-2 mt-auto">
                      {cat.skills.map((skill) => (
                        <div
                          key={skill.name}
                          className="flex items-center justify-between p-2 rounded-xl bg-slate-50 border border-slate-100/55"
                        >
                          <div className="flex items-center gap-2">
                            {getSkillIcon(skill.iconName)}
                            <span className="text-xs font-medium text-slate-700">{skill.name}</span>
                          </div>
                          <span className="text-[10px] font-mono px-2 py-0.5 bg-slate-200/50 rounded-md text-slate-500 uppercase">
                            {skill.level}
                          </span>
                        </div>
                      ))}
        ...
        <section id="interactive-topology" className="py-20 bg-white border-t border-slate-200/80">
          <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-3xl mb-12">
              ...
              <p className="text-xl text-slate-800 font-display font-semibold tracking-tight sm:text-3xl leading-snug">
                Production-grade environments and secure system diagrams, mapped.
              </p>
            </div>
        ...
        <section id="projects" className="py-20 bg-slate-50/50 border-t border-slate-200/80 relative">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl mb-16">
              ...
              <p className="text-xl text-slate-800 font-display font-semibold tracking-tight sm:text-3xl leading-snug">
                Building multi-tenant enterprise ERP frameworks and tailored business solutions.
              </p>
            </div>
            ...
            <div className="space-y-12 mb-16">
              {flagshipProjects.map((project, idx) => (
                <div
                  ...
                  className="bg-white border border-slate-200 hover:border-slate-300 rounded-2xl p-6 md:p-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center transition-all duration-300 relative overflow-hidden group shadow-xs"
                >
                  ...
                  <div className="lg:col-span-8 flex flex-col justify-between h-full">
                    <div>
                      {/* Tag Badge */}
                      <span className="inline-block px-3 py-1 bg-slate-100 border border-slate-200 text-slate-600 font-mono text-[10px] uppercase tracking-wider rounded-lg mb-4">
                        {project.tag}
                      </span>

                      {/* Title */}
                      <h3 className="font-display font-bold text-2xl sm:text-3xl text-slate-800 tracking-tight mb-4">
                        {project.title}
                      </h3>

                      {/* Description */}
                      <p className="text-sm sm:text-base text-slate-650 mb-6 leading-relaxed font-normal">
                        {project.description}
                      </p>
            ...
            <div className="border-t border-slate-200/85 pt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {freelanceProjects.map((fProj, fIdx) => (
                  <div
                    key={fIdx}
                    id={`freelance-card-${fIdx}`}
                    className="p-6 bg-white border border-slate-200 hover:border-indigo-100 rounded-2xl shadow-xs transition-all duration-300 flex flex-col justify-between"
                  >
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <a
                          ...
                          referrerPolicy="no-referrer"
                          rel="noopener noreferrer"
                          className="p-1 px-2.5 bg-slate-50 border border-slate-200 text-[10px] font-mono text-cyan-600 hover:text-cyan-700 rounded hover:border-slate-300 flex items-center gap-1 transition-all cursor-pointer"
                        >
        ...
        <section id="timeline" className="py-20 bg-white border-t border-slate-200/80 relative">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl mb-12">
              ...
              <p className="text-xl text-slate-800 font-display font-semibold tracking-tight sm:text-3xl leading-snug">
                11+ Years of professional experience architecting reliable transaction systems.
              </p>
            </div>
              ...
              {careerTimeline.map((item, idx) => (
                <div key={item.id} className="relative group">
                  ...
                  <div className="p-6 bg-slate-50/50 group-hover:bg-slate-50 border border-slate-200 rounded-2xl transition-all duration-300">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-slate-550 leading-none block mt-0.5">{item.company} &mdash; <span className="font-mono text-[10px] bg-slate-100 text-slate-600 px-1 py-0.5 rounded">{item.location}</span></span>
                        </div>
                      </div>
                    ...
                    <p className="text-xs sm:text-sm text-slate-650 leading-relaxed font-normal mb-4">
                      {item.description}
                    </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col">
                ...
                <h3 className="font-display font-bold text-3xl sm:text-4xl text-slate-800 tracking-tight leading-tight mb-4">
                  Get In Touch
                </h3>
                <p className="text-sm text-slate-600 leading-relaxed mb-8 max-w-md">
                  Have a web application, modern microservice deployment, or relational database architecture project? I'd love to chat. Feel free to use the contact form, shoot over an email, or message me directly on WhatsApp.
                </p>
              ...
              <div className="lg:col-span-7 bg-white border border-slate-200 p-6 sm:p-8 rounded-3xl relative shadow-xs">
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="form-name" className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Your Name</label>
                      <input
                        id="form-name"
                        type="text"
                        required
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs text-slate-800 focus:outline-none focus:border-indigo-600 focus:bg-white"
                        placeholder="e.g. Alexis Chen"
                      />
                    </div>
                    <div>
                      <label htmlFor="form-email" className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Your Email</label>
                      <input
                        id="form-email"
                        type="email"
                        required
                  ...
                  <div>
                    <label htmlFor="form-company" className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Company (Optional)</label>
                    <input
                      id="form-company"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="form-message" className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Message Details</label>
                    <textarea
                      id="form-message"
                      rows={4}
                      required
                  ...
                  <div className="pt-2">
                    <button
                      id="submit-contact"
                      type="submit"
                      disabled={formSentState !== 'idle'}
                      className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-sm rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm"
                    >
                      {formSentState === 'idle' && (
                        <>
                  ...
                  <div className="flex items-start gap-2 bg-slate-50 p-3 border border-slate-200 rounded-xl mt-4">
                    ...
                    <p className="text-[11px] text-slate-500 leading-snug">
                      Note: Submitting this form temporarily models message transfer to simulated local parameters. Your message won't be leaked and will be processed immediately. You can also click the email or WhatsApp link on the left.
                    </p>
                  </div>
                </form>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4 items-center">
            <a
              ...
              referrerPolicy="no-referrer"
              rel="noopener noreferrer"
              className="p-2 border border-slate-200 text-slate-500 hover:text-indigo-600 hover:border-slate-350 bg-white rounded-xl transition-all"
            >
              <Github className="w-4 h-4" />
            </a>
            <a
            ...
            <a
              id="footer-mailto"
              href="mailto:mehboobfazal36@gmail.com"
              aria-label="Mail Direct Action"
              className="p-2 border border-slate-200 text-slate-400 hover:text-indigo-600 hover:border-slate-350 bg-white rounded-xl transition-all"
            >
