                ...
                <section id="hero" className="relative min-h-[95vh] flex items-center pt-16 pb-16 overflow-hidden bg-gradient-to-b from-white to-slate-50/50">
                    ...
                    <div className="max-w-7xl mx-auto px-6 w-full z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="lg:col-span-7 flex flex-col">
                            ...
                            <p className="text-sm sm:text-base text-slate-600 max-w-2xl mb-10 leading-relaxed">I design and build full-stack enterprise solutions, multi-tenant databases, and custom RAG engines. Over my career, I've focused on translating complex business logic into maintainable systems, transitioning seamlessly from classic .NET environments to modern cloud architectures.</p>
